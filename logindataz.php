...
$access=$_SESSION['access'];
 ...
 $query = "SELECT * FROM login, logindata WHERE login.username=logindata.username AND datetime >= CONCAT(CURDATE(), ' 00:00:00') && datetime < CONCAT(CURDATE(), ' 23:59:59') ORDER BY datetime DESC";
 ...
 <html>
      ...
      <body onload="startTime()">
           ...
           <div class="container" style="width:600px;">
           		...
           		<a href="sensor_datac.php"><div class="sensor-button" style="float:right; width:25%;">Timeline Sensor Data</div></a><br />
           		<br /><div style="font-weight: bold" id="currenttime" ></div>
                <h2 align="center">HomeSensor Timeline Login Data</h2><br />
                ...
                <div id="order_table">
                     ...
                     ?>
                          <tr>
                               ...
                               <td><?php echo JSdate($row["datetime"], 'datetime'); ?></td>
                          </tr>
                     <?php
                     }
                     ?>
